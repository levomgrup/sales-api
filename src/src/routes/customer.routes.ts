 ...
 *     tags:
 *       - Customers
 *     summary: Müşteri bakiyesini güncelle
 *     parameters:
 *       - in: path
 *         name: customerId
 *         required: true
 ...
 *               balance:
 *                 type: number
 *                 description: Yeni bakiye değeri
 *     responses:
 *       200:
 *         description: Bakiye başarıyla güncellendi
 *       404:
 *         description: Müşteri bulunamadı
 */
router.patch('/:customerId/balance', updateBalance);
